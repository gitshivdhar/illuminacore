...
const manpowerHero = document.querySelector('.manpower-hero');
const manpowerHeroBg = document.querySelector('.manpower-hero .hero-bg');
const manpowerHeroContent = document.querySelector('.manpower-hero .hero-content');

if (manpowerHeroBg) {
    manpowerHeroBg.classList.add('active');
    manpowerHeroBg.classList.add('zoom');
}

if (manpowerHero && manpowerHeroContent) {
    setTimeout(() => {
        manpowerHero.classList.add('text-show');
        manpowerHeroContent.classList.add('text-show');
    }, 260);
}
