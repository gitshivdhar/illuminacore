...
const payrollHero = document.querySelector('.payroll-hero');
const payrollHeroBg = document.querySelector('.payroll-hero .hero-bg');
const payrollHeroContent = document.querySelector('.payroll-hero .hero-content');

if (payrollHeroBg) {
    payrollHeroBg.classList.add('active');
    payrollHeroBg.classList.add('zoom');
}

if (payrollHero && payrollHeroContent) {
    setTimeout(() => {
        payrollHero.classList.add('text-show');
        payrollHeroContent.classList.add('text-show');
    }, 260);
}
